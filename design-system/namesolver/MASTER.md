...
- **Heading Font:** Chiron GoRound TC
- **Body Font:** Chiron GoRound TC
- **Mood:** modern, friendly, approachable, distinctly Taiwanese, readable
- **Google Fonts:** [Chiron GoRound TC](https://fonts.google.com/specimen/Chiron+GoRound+TC)

**CSS Import:**
```css
@import url('https://fonts.googleapis.com/css2?family=Chiron+GoRound+TC:wght@400;500;600;700;800&display=swap');
```
